...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Code for Sharon project.")
...
if(WIN32 AND CMAKE_GENERATOR MATCHES "^Visual Studio")
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "teo-sharon_${CPACK_PACKAGE_VERSION}_${CPACK_SYSTEM_NAME}")

    # Miscellanea.
    set(CPACK_NSIS_HELP_LINK "http://github.com/roboticslab-uc3m/teo-sharon/")
...
if(UNIX)
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "teo-sharon-${CPACK_PACKAGE_VERSION}.${CPACK_SYSTEM_NAME}")
endif()

...
pathObjects = r"/home/elisabeth/data/darknet11Objects/data/obj/"
pathImages = r"/home/elisabeth/data/teoDataset11Objects/all_images/"
pathTxt = r"/home/elisabeth/data/darknet11Objects/data/"
...
print(len(trainList))
valList = imagesList[int(0.9*len(imagesList))+1:]
print("val:",valList)
...
for image in trainList:
    fileTrain.write(pathObjects[38:]+image+'\n')

for image in valList:
    fileVal.write(pathObjects[38:]+image+'\n')   

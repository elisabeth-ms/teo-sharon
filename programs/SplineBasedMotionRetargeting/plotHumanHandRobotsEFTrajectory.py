...
csvPoseFileWrite =  "/home/elisabeth/repos/teo-sharon/programs/MapHumanToRobotMotionPerFrameIK/trajectories/prueba" + str(nDemo) + "-poses-spline-optimization.csv";
csvDataFileWrite = "/home/elisabeth/repos/teo-sharon/programs/MapHumanToRobotMotionPerFrameIK/trajectories/prueba" + str(nDemo) + "-spline-data-optimization.csv";
csvQFileWrite = "/home/elisabeth/repos/teo-sharon/programs/MapHumanToRobotMotionPerFrameIK/trajectories/prueba" + str(nDemo) + "-q-spline-optimization.csv"

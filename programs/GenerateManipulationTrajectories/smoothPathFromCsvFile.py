...
qz = []
qw = []
with open('trajectories/graspcup2/test-right-arm-motion23.csv') as csv_file:
...
csv_file_write = open("trajectories/graspcup2/test-right-arm-motion-smooth23.csv", "w")
